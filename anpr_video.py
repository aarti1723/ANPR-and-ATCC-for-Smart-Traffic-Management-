...
def start_anpr(input_files):
    ...
    model = OCR(
    modelFile=r"C:\Users\aarti\OneDrive\Desktop\ANPR and ATCC for smart traffic management\models\binary_128_0.50_ver3.pb",
    labelFile=r"C:\Users\aarti\OneDrive\Desktop\ANPR and ATCC for smart traffic management\models\binary_128_0.50_labels_ver2.txt"
)
...
if __name__ == "__main__":
	video_file=[r"C:\Users\aarti\OneDrive\Desktop\ANPR and ATCC for smart traffic management\Sample detection videos\anpr sample.mp4"]
